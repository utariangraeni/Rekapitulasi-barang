...
<body>
    ...
    <button id="Edit" role="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Edit</button>
                ...
                <tr>
                    ...
                    <td>
                        <button
                            ...
                            data-bs-target="#editModal" onclick="ambilDataTable(this)">
                            Edit
                        </button>
                        </form>
                    </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../../../CONTROL/DATA_SUPPLIER/DATA_SUPPLIER_CONTROL.php" method="post">
                        ...
                        <div>
                            <label for="editAlamatS">Alamat Supplier</label>
                            <input type="text" name="editAlamatS" id="editAlamatS">
                        </div>
                        <div>
                            <label for="editNoS"> No Telp</label>
